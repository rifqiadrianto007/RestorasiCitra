...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen py-8 px-4">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-10">
            <h2 class="text-4xl font-bold text-gray-800 mb-2">Gaussian Smoothing</h2>
            <p class="text-gray-600">Upload gambar dan terapkan efek smoothing Gaussian</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6">
                ...
                <form action="{{ route('smooth.process') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                    @csrf
                    ...
                    <div class="mb-6">
                        <label for="level" class="block text-sm font-medium text-gray-700 mb-3">
                            Tingkat Kehalusan: <span id="levelValue" class="text-indigo-600 font-semibold">5</span>
                        </label>

                        <div class="flex items-center space-x-4">
                            <span class="text-xs text-gray-500">Rendah</span>
                            <input type="range" name="level" id="level" min="1" max="20" value="5"
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6">
                ...
                @else
                    ...
                    <div class="flex flex-col items-center justify-center h-full py-12 text-center">
                        ...
                        <p class="text-gray-500">Upload gambar dan atur tingkat kehalusan untuk melihat hasil di sini</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <script>
        ...
        // Smoothing level slider functionality
